...
export function UIPlayground() {
  ...
  const samplePrompt = {
    ...
    title: 'Professional Email Generator',
    description:
      'Create compelling professional emails with proper tone, structure, and persuasive elements. Perfect for business communication, sales outreach, and client relations.',
  ...
  const sampleComments = [
    {
      id: 'comment-1',
      content:
        "This prompt works amazingly well for sales emails! I've increased my response rate by 40% using it.",
    ...
    },
    {
      id: 'comment-2',
      content:
        'Great template! I modified it slightly to work better with LinkedIn messages. Thanks for sharing!',
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-xl text-muted-foreground">
          Experiment with different UI designs before implementing them in the
          main platform.
        </p>
      </div>
          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Full demonstration of ALL features in our prompt platform - from
                ...
                <div className="border-b bg-gray-50 p-6">
                        ...
                        <Badge
                          className={`${
                            samplePrompt.type === 'text'
                              ...
                              : samplePrompt.type === 'image'
                                ? 'bg-purple-100 text-purple-800'
                                : samplePrompt.type === 'code'
                                  ? 'bg-green-100 text-green-800'
                                  : samplePrompt.type === 'agent'
                                    ? 'bg-orange-100 text-orange-800'
                                    : 'bg-gray-100 text-gray-800'
                          }`}
                        >
                          {samplePrompt.type.charAt(0).toUpperCase() +
                            samplePrompt.type.slice(1)}
                        </Badge>
                        <Badge variant="outline">{samplePrompt.category}</Badge>
                        <Badge variant="secondary">
                          {samplePrompt.visibility}
                        </Badge>
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="font-medium">
                          {samplePrompt.author.name}
                        </div>
                        <div className="text-sm text-muted-foreground">
                          @{samplePrompt.author.username} •{' '}
                          {samplePrompt.author.reputation} rep
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 mr-1 ${isHearted ? 'fill-current' : ''}`}
                        />
                        {hearts}
                      </Button>
                  ...
                  <div className="border-b p-6">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-lg font-semibold">
                        Images ({samplePrompt.images.length})
                      </h3>
                    </div>
                ...
                <Tabs defaultValue="content" className="w-full">
                  <div className="border-b">
                    <TabsList className="w-full justify-start rounded-none bg-transparent h-auto p-0 mb-6">
                      ...
                      >
                        Discussion (
                        {feedbackStats.total + sampleComments.length})
                        {feedbackStats.successRate !== null &&
                          ` • ${feedbackStats.successRate}% success`}
                      </TabsTrigger>
                    </TabsList>
                  </div>
                      ...
                      <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              copyToClipboard(samplePrompt.content, 'content')
                            }
                          >
                  ...
                  <TabsContent value="template" className="p-6">
                    <Card>
                      <CardHeader>
                        ...
                        <p className="text-sm text-muted-foreground">
                          You can copy and customize this template as a starting
                          point for your own prompt.
                        </p>
                      </CardHeader>
                      <CardContent>
                        <div className="bg-muted p-4 rounded-lg">
                      ...
                      {!feedbackSubmitted ? (
                        <Card>
                          <CardHeader>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Help others by sharing how well this prompt worked
                              for you
                            </p>
                          </CardHeader>
                          <CardContent className="space-y-4">
                            <div>
                              <label className="text-sm font-medium">
                                How well did this prompt work for you?
                              </label>
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-green-800 font-medium">
                              Thank you for your feedback! You rated this prompt
                              as{' '}
                              <strong>
                                {feedbackRating === 'positive'
                                  ? 'working well'
