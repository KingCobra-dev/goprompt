...
export function PromptDetailPage({
  ...
  useEffect(() => {
    console.log(
      'PromptDetailPage: Starting to load prompt data for promptId:',
      promptId
    )
    const loadPromptData = async () => {
      try {
        ...
        if (!error && fullPromptData) {
          ...
          console.log(
            'PromptDetailPage: Setting prompt data for promptId:',
            promptId
          )
  ...
  if (!prompt) {
    console.log(
      'PromptDetailPage: Rendering "Prompt not found" for promptId:',
      promptId
    )
    return (
  ...
  const isHearted = state.hearts.some(
