...
export const getComingSoonMessage = (feature: FeatureFlag): string => {
  const messages: Partial<Record<FeatureFlag, string>> = {
    ...
    SUBSCRIPTIONS:
      'Premium subscriptions with advanced features are coming soon!',
    ...
    PERFORMANCE_TRACKING:
      'Performance tracking and optimization tools are coming soon!',
    CUSTOM_DOMAINS: 'Custom domain support for portfolios is coming soon!',
    PREMIUM_PACKS:
      'Premium prompt packs with exclusive content are coming soon!',
